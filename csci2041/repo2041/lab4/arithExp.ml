...
let e1 = AddExpr (ConstExpr 1.414, MultExpr(ConstExpr 3.14, ConstExpr 2.0))
let e2 = MultExpr (ConstExpr 3.0, AddExpr(ConstExpr 2.0, ConstExpr 1.0))
(* and strings that create each of these expressions in RPN here *)
let s1 = "1.414 3.14 2.0 * +"
let s2 = "3.0 2.0 1.0 + *"
